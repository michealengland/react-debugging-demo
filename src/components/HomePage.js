...
function HomePage() {
	...
	return (
        ...
        <div className='home-text'>
          ...
          <p className='home-title'>You can clone the repo <a target="_blank" className='gh-link' rel="noreferrer" href="https://github.com/michealengland/react-debugging-demo">here</a>, and feel free to reach out if you have any questions </p>
